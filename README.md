...
1. DynaShapePackage
1.1. pkg.json (provided with the Visual Studio solution)
1.2. bin
1.2.1. DynaShape.dll
1.2.2. DynaShape_DynamoCustomization.xml (provided with the Visual Studio  solution)
1.2.3. MathNet.Numerics.dll
